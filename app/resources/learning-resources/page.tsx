...
export default function LearningResourcesPage() {
  return (
    <>
      ...
      <section>
        <p>Text about learning resources.</p>
        <p>
          3 options: 1. Bootcamp to learn 0 to 100, 2. Challenges and projects,
          3. All resources.
        </p>
      </section>
      ...
      <section id="bootcamps">
        ...
        <p>
          Short, intensive workshops designed to bring participants up to speed
          quickly for hackathons.
        </p>
        <ul>
          <li>
            <strong>Beginner Bootcamp</strong> — Intro to quantum concepts,
            basic tooling, and sample projects. (Add links/resources here.)
          </li>
          <li>
            <strong>Application Bootcamp</strong> — Hands-on sessions on
            building a hackathon project end-to-end.
          </li>
          <li>
            <strong>Machine Learning for Quantum</strong> — Focused bootcamp
            for hybrid workflows (optional).
          </li>
        </ul>
      </section>
      ...
      <section id="lectures">
        <h2>Lectures</h2>
        <p>
          Recorded and live lecture series useful for learning fundamentals and
          advanced topics.
        </p>
        <ul>
          <li>University lecture series (link to playlists or course pages)</li>
          <li>
            Conference talks (select recommended talks with short notes)
          </li>
      ...
      <section id="textbooks">
        <h2>Textbooks</h2>
        <p>
          Books and longer-form references to dive deeper into theory and
          practice.
        </p>
        <ul>
      ...
      <section id="other-resources">
        <h2>Other</h2>
        <p>
          Miscellaneous resources that don&apos;t fit neatly into the
          categories above.
        </p>
        <ul>
