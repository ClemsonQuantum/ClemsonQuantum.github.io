...
# image: "/images/CI-poster-ian-lewis.png"   # add poster image -> shows as a framed image
# pdf: "/files/CI-poster-ian-lewis.pdf"       # add poster PDF -> shows in embedded viewer
